// Static system configuration definitions
// These are hardcoded and don't require database migrations when changed
...
export interface ConfigDefinition {
  ...
  category: string;
  defaultValue: string;
  isPublic?: boolean; // Whether this config can be accessed without authentication
...
export const SYSTEM_CONFIG_DEFINITIONS: ConfigDefinition[] = [
  ...
  {
    key: 'whatsapp_verification_enabled',
    name: 'WhatsApp Verification Enabled',
    description: 'Enable WhatsApp verification for phone number authentication',
    type: 'boolean',
    category: 'auth',
    defaultValue: 'true',
  },

  // Signin Method Settings
  {
    key: 'signin_email_enabled',
    name: 'Email Signin Enabled',
    description: 'Allow users to sign in using email address',
    type: 'boolean',
    category: 'auth',
    defaultValue: 'true',
  },
  {
    key: 'signin_phone_enabled',
    name: 'Phone Signin Enabled',
    description: 'Allow users to sign in using phone number',
    type: 'boolean',
    category: 'auth',
    defaultValue: 'true',
  },
  {
    key: 'signin_whatsapp_enabled',
    name: 'WhatsApp Signin Enabled',
    description: 'Allow users to sign in using WhatsApp number',
    type: 'boolean',
    category: 'auth',
    defaultValue: 'false',
  },
  {
    ...
    name: 'Phone Verification Required',
    description: 'Require phone number verification for all users',
    type: 'boolean',
    category: 'auth',
    defaultValue: 'false',
  },
  ...
  },
  {
    ...
    name: 'Password Reset Token Expiry (hours)',
    description: 'Expiry time for password reset tokens in hours',
    type: 'number',
    category: 'auth',
    defaultValue: '24',
  },
  ...
  },
  {
    ...
    description: 'Select which email service to use for sending emails',
    type: 'select',
    category: 'auth',
    defaultValue: 'smtp',
    allowAddOptions: true,
  ...
  },
  {
    key: 'fast2sms_mode',
    name: 'Fast2SMS Mode',
    description: 'Select Fast2SMS message mode (only applies when Fast2SMS is selected)',
    type: 'select',
    category: 'auth',
    defaultValue: 'otp',
    allowAddOptions: true,
  ...
  {
    key: 'whatsapp_service_provider',
    name: 'WhatsApp Service Provider',
    description: 'Select which service to use for WhatsApp messaging',
    type: 'select',
    category: 'auth',
    defaultValue: 'fast2sms',
    allowAddOptions: true,
  ...
  {
    key: 'fast2sms_whatsapp_mode',
    name: 'Fast2SMS WhatsApp Mode',
    description: 'Select Fast2SMS WhatsApp message mode (only applies when Fast2SMS is selected)',
    type: 'select',
    category: 'auth',
    defaultValue: 'otp',
    allowAddOptions: true,
  ...
  // Notification Settings
  {
    ...
    description: 'Enable email notifications for bookings and updates',
    type: 'boolean',
  ...
  },
  {
    ...
    description: 'Enable SMS notifications for bookings and updates',
    type: 'boolean',
    category: 'notifications',
    defaultValue: 'false',
  },
  ...
  // Order Request Notifications (when customer requests booking - sent to salon)
  {
  ...
  // Order Placed Notifications (when customer creates booking - sent to customer)
  {
  ...
  // SMS Templates
  {
    ...
    type: 'template',
    category: 'notifications',
    defaultValue: '1', // ID of the active template
    options: [
      {
        id: '1',
  ...
  },
  {
    ...
    description: 'SMS template for new booking requests to salon. Use {#var#} for dynamic values. Variables: customerName, serviceName, date, time.',
    type: 'template',
    category: 'notifications',
    defaultValue: '1', // ID of the active template
    options: [
      {
        id: '1',
        message: 'CutQ: New booking request from {#var#} for {#var#} on {#var#} at {#var#}. Please confirm via your dashboard. Powered by - gem infinity',
        templateId: ''
      }
    ],
    allowAddOptions: true,
  },
  {
    ...
    description: 'SMS template for booking placed confirmation to customer. Use {#var#} for dynamic values. Variables: salonName, date, time, serviceName, verificationCode.',
    type: 'template',
    category: 'notifications',
    defaultValue: '1', // ID of the active template
    options: [
      {
        id: '1',
        message: 'CutQ: Your booking at {#var#} is placed successfully! {#var#} at {#var#} for {#var#}. Verification Code: {#var#}. Awaiting confirmation. Powered by - gem infinity',
        templateId: ''
      }
    ],
    allowAddOptions: true,
  },
  {
    ...
    description: 'SMS template for booking confirmation to customer. Use {#var#} for dynamic values. Variables: salonName, date, time, serviceName, userCode.',
    type: 'template',
    category: 'notifications',
    defaultValue: '1', // ID of the active template
    options: [
      {
        id: '1',
        message: 'CutQ: Your booking at {#var#} is CONFIRMED! {#var#} at {#var#}. Service Code: {#var#}. Present this code. Powered by - gem infinity',
        templateId: ''
      }
    ],
    allowAddOptions: true,
  ...
  },
  {
    ...
    description: 'Send email reminders before appointments',
    type: 'boolean',
    category: 'notifications',
    defaultValue: 'false',
  },
  ...
  // Booking Settings
  {
    ...
    name: 'Maximum Advance Booking Days',
    description: 'Maximum days in advance customers can book appointments',
    type: 'number',
    category: 'booking',
    defaultValue: '30',
  },
  {
    ...
    name: 'Minimum Booking Notice Hours',
    description: 'Minimum hours notice required for new bookings',
    type: 'number',
    category: 'booking',
    defaultValue: '2',
  },
  {
    ...
    description: 'Allow customers to book appointments on the same day',
    type: 'boolean',
    category: 'booking',
    defaultValue: 'true',
  },
  {
    key: 'max_reschedule_limit',
    name: 'Maximum Reschedule Limit',
  ...
  },
  {
    ...
    description: 'Allow bookings without user registration',
    type: 'boolean',
    category: 'booking',
    defaultValue: 'true',
  },
  ...
  // Payment Settings
  {
    key: 'payment_required_for_booking',
    name: 'Payment Required for Booking',
    description: 'Require payment to complete booking. When disabled, bookings are confirmed without payment.',
    type: 'boolean',
    category: 'payment',
    defaultValue: 'true',
  },
  {
    ...
    description: 'Enable Razorpay payment gateway. When disabled, payment dialog is bypassed.',
    type: 'boolean',
    category: 'payment',
    defaultValue: 'true',
  },
  {
    ...
    description: 'Time limit for completing payment after booking creation',
    type: 'number',
    category: 'payment',
    defaultValue: '15',
  },
...
export const getPublicConfigs = (): ConfigDefinition[] => {
  return SYSTEM_CONFIG_DEFINITIONS.filter(config => config.isPublic === true);
};
