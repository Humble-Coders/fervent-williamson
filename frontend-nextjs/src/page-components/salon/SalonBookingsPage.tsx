...
const SalonBookingsPage: React.FC = () => {
  ...
  const loadBookings = async () => {
    try {
      ...
      // In a real implementation, you'd have a salon-specific bookings endpoint
      const response = await fetch('/api/v1/bookings/salon/current', {
        headers: {
